        ...
        .then(response => response.text())
                .then(html => {
                    ...
                    data.forEach(function(entry, idx) {
                        ...
                        templateText.getElementById('join-date').innerText = entry.joinDate;
                        templateText.getElementById('description').innerText = entry.description;
                        templateText.getElementById('responsibilities').innerText = entry.responsibilities;
                        templateText.getElementById('impact').innerText = entry.impact;
